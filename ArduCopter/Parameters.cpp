...
const AP_Param::GroupInfo ParametersG2::var_info2[] = {
    ...
    AP_GROUPINFO("ZE_STAR_ALT_CM", 10, ParametersG2, ze_star_alt_cm, 600.0f),
    AP_GROUPINFO("ZE_STAR_X_CM", 11, ParametersG2, ze_star_x_cm, 0.0f),
    AP_GROUPINFO("ZE_STAR_Y_CM", 12, ParametersG2, ze_star_y_cm, 0.0f),
    AP_GROUPINFO("ZE_STAR_Z_CM", 13, ParametersG2, ze_star_z_cm, 0.0f),
#endif
